...
export default function Home() {
  return (
    <main className="bg-gradient-lime flex flex-col items-center justify-between p-24 relative z-50 w-full mx-auto h-[calc(100vh-40px)] rounded-xl border border-gray-800 overflow-hidden">
    <nav className="absolute top-0 bg-greenlime text-gray-900 w-full p-2 flex flex-row items-center justify-between">
     ...
     <section className="flex flex-col ">
      ...
      <h4 className="text-3xl text-greenlime"> Tu nueva  <span className="font-semibold"> billetera virtual</span> </h4>
     </section>
      ...
      <footer className="absolute bottom-0 bg-gray-700 text-greenlime w-full p-3 ">
